...
const mockDefinitions: WorkflowDefinition[] = [
  {
    ...
    is_preset: true,
    phases: [
      { id: 1, workflow_definition_id: 1, name: "Plan", slug: "plan", order_index: 0, gate_type: "auto", system_prompt_template: "", command_prompt_template: "", artifact_template: "", input_phase_slugs: [], model_override: "", agent_type: "workflow" as const },
    ],
  ...
  },
  {
    ...
    is_preset: true,
    phases: [
      { id: 2, workflow_definition_id: 2, name: "Spec", slug: "spec", order_index: 0, gate_type: "approval", system_prompt_template: "", command_prompt_template: "", artifact_template: "", input_phase_slugs: [], model_override: "", agent_type: "workflow" as const },
      { id: 3, workflow_definition_id: 2, name: "Build", slug: "build", order_index: 1, gate_type: "auto", system_prompt_template: "", command_prompt_template: "", artifact_template: "", input_phase_slugs: ["spec"], model_override: "", agent_type: "workflow" as const },
    ],
    created_at: "2025-01-01",
    updated_at: "2025-01-01",
  },
