...
export default function EditorSplitTree({ node, featureId, projectId }: EditorSplitTreeProps) {
  ...
  return (
    <ResizablePanelGroup orientation={orientation} className="h-full">
      <ResizablePanel defaultSize={50}>
        <EditorSplitTree node={node.children[0]} featureId={featureId} projectId={projectId} />
      </ResizablePanel>
      <ResizableHandle />
      <ResizablePanel defaultSize={50}>
        <EditorSplitTree node={node.children[1]} featureId={featureId} projectId={projectId} />
      </ResizablePanel>
    </ResizablePanelGroup>
  );
}
