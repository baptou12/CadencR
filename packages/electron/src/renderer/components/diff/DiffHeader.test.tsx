...
describe("DiffHeader", () => {
  it("renders file count", () => {
    render(
      <DiffHeader fileCount={3} totalAdditions={10} totalDeletions={5} />,
    );
  ...
  it("renders singular 'file' for count=1", () => {
    render(
      <DiffHeader fileCount={1} totalAdditions={2} totalDeletions={1} />,
    );
  ...
  it("renders additions and deletions", () => {
    render(
      <DiffHeader fileCount={2} totalAdditions={42} totalDeletions={7} />,
    );
