    ...
    it("returns combined project columns and EAV rows", async () => {
      ...
      mockDb.prepare.mockImplementation(() => ({
        get: vi.fn().mockImplementation(() => {
          if (callCount++ === 0) return { branch_prefix: "feat/", qa_prompt: null, agent_autonomy: "2", model_plan: null, model_prd: null, model_execute: null, model_risk: null, model_review: null, model_session: null, model_qa: null };
          return undefined;
        }),
