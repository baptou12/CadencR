...
- Markdown rendering: `src/renderer/components/Markdown.tsx` already exists with Dracula-themed styling, GFM support, code blocks, tables, etc.
...
- **Markdown component**: Already exists at `src/renderer/components/Markdown.tsx` — reuse it directly
...
|------|--------|-------------|
| 1    | 1      | tRPC route must exist before UI components can query it |
| 2    | 2      | PhaseCard depends on tRPC types and existing Markdown component |
| 3    | 3      | Sidebar component depends on PhaseCard |
| 4    | 4      | Integration depends on sidebar component |
